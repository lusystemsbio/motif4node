...
load("/work/lulab/Ben/BenStuff/research/projects/oldhome/scripts/networks/clustscore/term2/scoremat.2.final")
term2 <- my_analysis(all.circuits = ALLUNIQUEMODELS, all.scores = scoremat, ylim = c(-4,4), color_breaks = seq(-4,4,by = 0.1), filename = "term2", decreasing = F)
